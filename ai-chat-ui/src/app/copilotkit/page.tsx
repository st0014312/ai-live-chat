...
export default function Page() {
  ...
  const chatStyles = running
    ? "w-2/3 border-r border-slate-200"
    : "w-1/2 h-1/2 mx-auto my-auto";
  ...
  return (
    <div {...props}>
      <CopilotChat
        ...
        labels={{
          initial:
            "Hi! I'm connected to your LangGraph agent. Ask me anything, and I'll show what's happening behind the scenes.",
